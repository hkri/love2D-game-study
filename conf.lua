...
--
-- If a file called conf.lua is present in your game folder (or .love file),
-- it is run before the LÖVE modules are loaded. You can use this file to overwrite
...
function love.conf(t)
    ...
    t.window.title = "My Love2D Game"    -- The window title (string)
