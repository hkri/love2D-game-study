...
local GAME_SCREEN = {main_menu}
local GAME_STATE  = 1

-- Do basic loading here.
function love.load()
  GAME_SCREEN[GAME_STATE].load()
end
...
function love.update(dt)
  GAME_SCREEN[GAME_STATE].update(dt)
end
...
function love.keypressed(key)
  GAME_SCREEN[GAME_STATE].keypressed(key)
end

-- Game draw/render loop
-- Draw graphics here.
function love.draw()
  GAME_SCREEN[GAME_STATE].draw(gfx)
end
